...
class Employee(Base):
    ...
    ResignedOn = Column(DateTime,   nullable=True)
    LastWorkingDay = Column(DateTime,   nullable=True)
    OfferRelesedOn = Column(DateTime,   nullable=True)  # Keep the typo to match DB
    OfferAcceptedOn = Column(DateTime,   nullable=True)
