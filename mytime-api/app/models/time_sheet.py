...
class Timesheet(Base):
    ...
    ModifiedOn = Column(DateTime, nullable=True)
    IsActive = Column(Boolean, nullable=True)
    TotalHrs = Column(BigInteger, nullable=True)

    # Relationship to TimesheetTask
    timesheet_tasks = relationship("TimesheetTask", back_populates="timesheet", lazy="selectin")
    
    # ✅ ADD THIS PROPERTY - This is the key fix!
    @property
    def tasks(self):
        return self.timesheet_tasks
